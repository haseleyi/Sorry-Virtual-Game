...
2. A brief description/justification of how it is constructed:
    ...
    In contrast, when the Player draws a 3, the program simply prompts them to select a piece to advance. 3 is an easy number to program the AI to move, however, cards like eleven or seven where there are many more options have more method calls for different situations trying to optimize the AI’s performance. 
